...
handle_t IRpcDemo_IfHandle;


extern const RPC_DISPATCH_TABLE IRpcDemo_v1_0_DispatchTable;

static const RPC_CLIENT_INTERFACE IRpcDemo___RpcClientInterface =
    {
...
RPC_IF_HANDLE IRpcDemo_v1_0_c_ifspec = (RPC_IF_HANDLE)& IRpcDemo___RpcClientInterface;

extern const MIDL_STUB_DESC IRpcDemo_StubDesc;

static RPC_BINDING_HANDLE IRpcDemo__MIDL_AutoBindHandle;
...
static const MIDL_STUB_DESC IRpcDemo_StubDesc = 
    {
    (void *)& IRpcDemo___RpcClientInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    &IRpcDemo_IfHandle,
    0,
...
static const MIDL_SERVER_INFO IRpcDemo_ServerInfo = 
    ...
    _callbackIRpcDemo_FormatStringOffsetTable,
    0,
    0,
    0,
    0};
